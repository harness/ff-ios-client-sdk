...
extension Event {
  ...
  fileprivate static func parseEvent(_ eventString: String, newLineCharacters: [String]) -> Event {
  ...
  fileprivate static func parseLine(_ line: String, newLineCharacters: [String]) -> (
