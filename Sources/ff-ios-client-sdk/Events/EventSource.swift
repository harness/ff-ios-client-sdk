...
open class EventSource: NSObject, EventSourceProtocol, URLSessionDataDelegate {
  ...
  public func connect(lastEventId: String? = nil) {
    ...
    urlSession = URLSession(
      configuration: configuration, delegate: self, delegateQueue: operationQueue)
...
extension EventSource {
  ...
  fileprivate func notifyReceivedEvents(_ events: [Event]) {
  ...
  fileprivate func shouldReconnect(statusCode: Int) -> Bool {
    switch statusCode {
    case 200:
      return false
